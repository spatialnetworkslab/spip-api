...
export const structure = {
  'name': 'Baangegevens Werkadres 2016',
  ...
  'db': 'server/data/sqlite/nodes-2016.sqlite',
  'spatialUnits': {
    'municipalities': {
      'id': 'gem',
      'table': 'woonwerk_werk_19992016_gem'
    },
    'postcodes': {
      'id': 'pc4',
      'table': 'woonwerk_werk_19992016_pc'
    }
  },
  'count': 'value',
  'weight': 'value',
  ...
  'total': function (query, parameters) {
    ...
    let count = 0
    for (let field in parameters.fields) {
